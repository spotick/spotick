...
//        저장된 장소로 사진도 저장해야함
    ...
    public Slice<PlaceListDto> findPlaceListPagination(Pageable pageable, Long userId, SortType sortType, AreaFilter areaFilter) {
        return placeRepository.findPlaceListPaging(pageable, userId, sortType, areaFilter);
    }
