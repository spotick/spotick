...
public class PlaceRegisterDto {
    ...
    @Min(message = "기본요.금을 올바르게 입력해주세요.",value = 0)
    private Integer placeDefaultPrice;  //기본요.금

    @Min(message = "추가요.금을 올바르게 입력해주세요.",value = 0)
    private Integer placeSurcharge;  //추가요.금
...
//    @Pattern(message = "계좌번호를 올바르게 입력해주세요.",regexp = "^\\d{10,16}$")
    ...
    @Size(min=5, max = 20,message = "사진은 최소 5장 이상, 20장 이하로 선택해주세요.")
